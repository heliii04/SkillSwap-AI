            ...
            <div className="relative w-full max-w-lg rounded-[32px] border border-white/10 bg-[#0d0d0d]/95 p-6 text-center shadow-2xl shadow-orange-950/20 sm:p-9">
                ...
                >
                    ...
                    <button
                        ...
                        className="mt-8 w-full rounded-xl bg-orange-500 px-5 py-3.5 text-sm font-semibold text-black transition hover:bg-orange-400 disabled:cursor-not-allowed disabled:opacity-60"
                    >
                        {isSubmitting
                            ? "Verifying..."
                            : "Verify Email"}
