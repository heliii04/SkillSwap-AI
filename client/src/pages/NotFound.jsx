        ...
        <div className="relative flex min-h-screen items-center justify-center bg-[#050505] p-6 text-white overflow-hidden">
            ...
            >
                ...
                <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4 w-full sm:w-auto">
                    <Link
                        to="/"
                        className="flex w-full sm:w-auto items-center justify-center gap-2 rounded-xl bg-orange-500 px-6 py-3.5 text-sm font-semibold text-black transition hover:bg-orange-400 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2 focus:ring-offset-[#050505]"
                    >
                    ...
                    {/* <Link
                        to="/search"
                        className="flex w-full sm:w-auto items-center justify-center gap-2 rounded-xl border border-white/10 bg-[#111111] px-6 py-3.5 text-sm font-medium text-white transition hover:border-gray-500 hover:bg-[#1a1a1a]"
                    >
