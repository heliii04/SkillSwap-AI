            ...
            <div className="relative z-10 max-w-3xl">
                ...
                <div className="mt-7 flex flex-col gap-3 sm:flex-row">
                    <button
                        type="button"
                        onClick={onExplore}
                        className="inline-flex items-center justify-center gap-2 rounded-xl bg-orange-500 px-5 py-3.5 text-sm  text-black transition hover:bg-orange-400 font-bold"
                    >
                        Explore people
                        <HiOutlineArrowRight className="text-lg animate-arrow-move" />
                    </button>

                    <button
                        type="button"
                        onClick={onAddSkill}
                        className="inline-flex items-center justify-center gap-2 rounded-xl border border-white/10 bg-white/[0.03] px-5 py-3.5 text-sm  text-white/70 transition hover:border-white/20 hover:bg-white/[0.06] hover:text-white font-bold"
                    >
