...
export default function SkillsTeach() {
        ...
        useCallback(async () => {
            try {
                ...
                if (!response.ok) {
                    throw new Error(
                        data?.message ||
                        "Unable to load teaching skills"
                    );
                }
    ...
    const handleSubmit = async (
        ...
        try {
            ...
            const url = isEditing
                ? `${API_URL}/skills/teach/${editingSkill.id}`
                : `${API_URL}/skills/teach`;
    ...
    const handleDelete = async (
        ...
        const confirmed =
            window.confirm(
                `Delete "${skill.title}" from your teaching skills?`
            );
        ...
        try {
            ...
            setError(
                requestError.message ||
                "Unable to delete teaching skill"
            );
        } finally {
            setDeletingId(null);
        }
                    ...
                    <div className="relative flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
                        <div>
                            ...
                            <p className="mt-3 max-w-2xl text-sm leading-7 text-white/45 sm:text-base">
                                Add the skills you can
                                teach so SkillSwap AI
                        ...
                        <button
                            ...
                            className="inline-flex shrink-0 items-center justify-center gap-2 rounded-xl bg-orange-500 px-5 py-3.5 text-sm  text-black transition hover:bg-orange-400 font-bold"
                        >
                ...
                <section className="mt-8">
                    <div>
                        ...
                        <p className="mt-2 text-sm text-white/40">
                            Manage the skills visible
                            to learners on SkillSwap.
                        </p>
                    </div>
    ...
    return (
        <article className="group flex min-h-80 flex-col rounded-[24px] border border-white/10 bg-[#101117] p-5 transition hover:-translate-y-1 hover:border-orange-500/35 sm:p-6">
            ...
            <div className="mt-5 flex flex-wrap gap-2">
                <Badge
                    icon={HiOutlineClock}
                    text={`${skill.yearsOfExperience} year(s)`}
                />
            ...
            <div className="mt-6 flex gap-3 border-t border-white/10 pt-5">
                <button
                    type="button"
                    onClick={onEdit}
                    className="inline-flex flex-1 items-center justify-center gap-2 rounded-xl border border-white/10 px-4 py-3 text-sm  text-white/55 transition hover:border-orange-500/30 hover:text-orange-400 font-bold"
                >
                    <HiOutlinePencilSquare />
                    Edit
                </button>
                ...
                <button
                    ...
                    onClick={onDelete}
                    disabled={deleting}
                    className="inline-flex items-center justify-center rounded-xl border border-red-500/20 px-4 py-3 text-red-300 transition hover:bg-red-500/10 disabled:opacity-50 font-bold"
            ...
            <div className="max-h-[92vh] w-full max-w-3xl overflow-y-auto rounded-[28px] border border-white/10 bg-[#101117]">
                ...
                >
                    ...
                    <TextAreaField
                        ...
                        onChange={onChange}
                        maxLength={1000}
                        placeholder="Explain what you can teach, your approach and what learners can expect."
                    />
    ...
    return (
        <div className="mt-5 flex min-h-80 flex-col items-center justify-center rounded-[24px] border border-dashed border-white/10 bg-[#101117] px-6 text-center">
            ...
            <p className="mt-2 max-w-md text-sm leading-7 text-white/40">
                Add your first skill so learners can
                discover your expertise and request a
                skill exchange.
            </p>
            ...
            <button
                type="button"
                onClick={onAdd}
                className="mt-6 inline-flex items-center gap-2 rounded-xl bg-orange-500 px-5 py-3 text-sm  text-black transition hover:bg-orange-400 font-bold"
            >
                <HiOutlinePlus />
                Add first skill
            </button>
