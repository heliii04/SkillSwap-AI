                ...
                <div className="relative mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8 lg:py-28">
                    ...
                    >
                        ...
                        <div className="mt-9 flex flex-col justify-center gap-4 sm:flex-row">
                            <Link
                                to="/browse-skills"
                                className="inline-flex items-center justify-center gap-2 rounded-xl bg-orange-500 px-6 py-3.5 text-sm  text-black hover:bg-orange-400 font-bold"
                            >
                                Explore Skills
                            ...
                            <Link
                                to="/how-it-works"
                                className="inline-flex items-center justify-center gap-2 rounded-xl border border-white/10 bg-white/[0.04] px-6 py-3.5 text-sm  text-gray-200 hover:border-orange-500/30 hover:bg-orange-500/10 hover:text-orange-400 font-bold"
                            >
                                How It Works
                            </Link>
                        </div>
