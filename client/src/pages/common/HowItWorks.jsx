                    ...
                    >
                        ...
                        <div className="mt-9 flex flex-col justify-center gap-4 sm:flex-row">
                            <Link
                                ...
                                className="inline-flex items-center justify-center gap-2 rounded-xl bg-orange-500 px-6 py-3.5 text-sm  text-black shadow-lg shadow-orange-500/20 transition hover:-translate-y-0.5 hover:bg-orange-400 font-bold"
                            >
                                Start Skill Swapping
                                <FiArrowRight className="animate-arrow-move"  />
                            </Link>

                            <Link
                                to="/browse-skills"
                                className="inline-flex items-center justify-center gap-2 rounded-xl border border-white/10 bg-white/[0.04] px-6 py-3.5 text-sm  text-gray-200 transition hover:-translate-y-0.5 hover:border-orange-500/30 hover:bg-orange-500/10 hover:text-orange-400 font-bold"
                            >
                                Browse Skills
                                <FiSearch />
                            </Link>
                    ...
                    <div className="grid items-center gap-12 lg:grid-cols-2">
                        ...
                        >
                            ...
                            <div className="relative rounded-[32px] border border-white/10 bg-[#0d0e15] p-5 shadow-2xl shadow-orange-950/20 sm:p-7">
                                ...
                                <button
                                    type="button"
                                    className="mt-5 w-full rounded-xl bg-orange-500 px-4 py-3 text-sm  text-black transition hover:bg-orange-400 font-bold"
                                >
                                    Send Swap Request
                                </button>
                            </div>
