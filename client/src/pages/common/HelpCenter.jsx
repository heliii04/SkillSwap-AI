            ...
            <section className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
                ...
                <div className="mt-16 text-center rounded-[32px] border border-orange-500/10 bg-orange-500/[0.015] p-8">
                    ...
                    <div className="mt-6 flex flex-col justify-center gap-4 sm:flex-row">
                        <Link
                            to="/contact"
                            className="inline-flex items-center justify-center rounded-xl bg-orange-500 px-5 py-3 text-sm  text-black hover:bg-orange-400 transition font-bold"
                        >
                            Open Support Ticket
                        </Link>
                        <Link
                            to="/faq"
                            className="inline-flex items-center justify-center rounded-xl border border-white/10 bg-white/[0.04] px-5 py-3 text-sm  text-gray-200 hover:border-orange-500/30 hover:bg-orange-500/10 hover:text-orange-400 transition font-bold"
                        >
                            Browse FAQ
                        </Link>
                    </div>
